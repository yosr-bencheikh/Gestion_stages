  ...
  <body>
    ...
    <div class="container mt-4" id="mainInterface">
      <div class="table-container">
        <div class="header">
          <h2>Liste des Étudiants en Stage d'initation</h2>
    ...
    <script>
      ...
      function editSoutenance(icon) {
        ...
        document.getElementById('jury1').value = cells[1].textContent;
        document.getElementById('jury2').value = cells[2].textContent;
        document.getElementById('societe').value = cells[3].textContent;
        const [dateDebut, dateFin] = cells[4].textContent.split(' à ');
        document.getElementById('dateDebut').value = dateDebut.trim();
        document.getElementById('dateFin').value = dateFin.trim();
        document.getElementById('classe').value = cells[5].textContent;
        document.getElementById('heure').value = cells[6].textContent;
        document.getElementById('date').value = cells[7].textContent;
